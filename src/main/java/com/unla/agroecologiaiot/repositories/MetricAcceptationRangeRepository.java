...
public interface MetricAcceptationRangeRepository extends JpaRepository<MetricAcceptationRange, Long>, JpaSpecificationExecutor<MetricAcceptationRange> {

    public abstract Optional<MetricAcceptationRange> findByName(String name);

    public abstract Optional<MetricAcceptationRange> findByMetricAcceptationRangeIdAndIsDeleted(long metricAcceptationRangeId, boolean isDeleted);
